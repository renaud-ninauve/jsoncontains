...
import static fr.ninauve.renaud.jsoncontains.JsonContainsPattern.jsonContains;
...
class JsonContainsPatternTest {
  ...
  void value(String pattern, String json, boolean expected) {
    final boolean actual = jsonContains(pattern).matches(json);
